...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      onTertiaryFixed: Color(0xff12144b),
      tertiaryFixedDim: Color(0xffbfc2ff),
      onTertiaryFixedVariant: Color(0xff3e4178),
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      tertiary: Color(0xff3a3d74),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff6c70aa),
      ...
      secondaryFixedDim: Color(0xff4d5990),
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff6c70aa),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff54578f),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff191b51),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff3a3d74),
      onTertiaryContainer: Color(0xffffffff),
      ...
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff1c285d),
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff3a3d74),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff24275c),
      onTertiaryFixedVariant: Color(0xffffffff),
      surfaceDim: Color(0xffdad9e0),
      surfaceBright: Color(0xfffaf8ff),
      surfaceContainerLowest: Color(0xffffffff),
  ...
  static MaterialScheme darkScheme() {
    return const MaterialScheme(
      ...
      onTertiary: Color(0xff282b60),
      tertiaryContainer: Color(0xff3e4178),
  ...
  static MaterialScheme darkMediumContrastScheme() {
    return const MaterialScheme(
      ...
      onSecondary: Color(0xff021046),
      secondaryContainer: Color(0xff828dc8),
      onSecondaryContainer: Color(0xff000000),
      tertiary: Color(0xffc4c6ff),
      onTertiary: Color(0xff0b0e45),
      tertiaryContainer: Color(0xff898cc8),
      ...
      tertiaryFixed: Color(0xffe0e0ff),
      onTertiaryFixed: Color(0xff060741),
      tertiaryFixedDim: Color(0xffbfc2ff),
      onTertiaryFixedVariant: Color(0xff2d3167),
      surfaceDim: Color(0xff121318),
      surfaceBright: Color(0xff38393f),
      surfaceContainerLowest: Color(0xff0d0e13),
      surfaceContainerLow: Color(0xff1a1b21),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      onSecondaryFixedVariant: Color(0xff021046),
      tertiaryFixed: Color(0xffe6e4ff),
      onTertiaryFixed: Color(0xff000000),
      tertiaryFixedDim: Color(0xffc4c6ff),
      onTertiaryFixedVariant: Color(0xff0b0e45),
      surfaceDim: Color(0xff121318),
      surfaceBright: Color(0xff38393f),
      surfaceContainerLowest: Color(0xff0d0e13),
      surfaceContainerLow: Color(0xff1a1b21),
